...
export default function WorldClockPage() {
  ...
  const [selectedCity, setSelectedCity] = useState<SavedCity | null>(() => {
    ...
    return saved.find(c => c.id === selId) || saved[0] || null;
  });
  ...
  return (
    <main className="h-screen w-screen relative select-none overflow-hidden bg-black text-white">
      {/* City View */}
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-4 py-2.5 bg-white/10 backdrop-blur-xl border border-white/15 rounded-full hover:bg-white/15 transition-colors cursor-pointer"
            >
